...
const UpdateCard = ({ update }) => {
    ...
    return (
        <article className="flex w-full flex-col gap-6 rounded-2xl border border-gray-200 bg-white p-5 sm:p-6 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-lg sm:flex-row sm:gap-8 xl:gap-10">
            ...
            <div className="flex flex-1 flex-col gap-4">
                ...
                <button type="button" className="mt-2 flex w-fit cursor-pointer items-center gap-2 font-semibold text-[#6044da] transition-all duration-300 hover:gap-3">
                    Read More
