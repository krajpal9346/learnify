...
const Blogs = () => {
                ...
                <div className="w-full px-5 sm:px-10 xl:px-20 pt-28 xl:pt-32 pb-10 bg-purple-50">
                    <div className="flex flex-col xl:flex-row justify-between items-center gap-10 xl:gap-20">
                        <div className="w-full xl:w-1/2 flex flex-col gap-6 text-center xl:text-left items-center xl:items-start">
                            ...
                            <p className="text-gray-600 text-base sm:text-lg xl:text-xl leading-8 max-w-2xl">
                                Discover expert insights, study tips, AI trends,
                                and career advice to accelerate your learning
                                journey.
                            </p>
                            ...
                            <div className="relative w-full max-w-2xl">
                                ...
                                <input
                                    ...
                                    className="w-full pl-14 pr-5 py-4 rounded-2xl border border-gray-300 outline-none bg-white"
                                />
                            </div>
                        </div>
                        ...
                        <div className="w-full xl:w-1/2 flex justify-center">
                            <img
                                src={blog}
                                alt="Learnify AI blogs illustration"
                                className="h-52 sm:h-64 md:h-72 xl:h-90 object-contain"
                            />
                        </div>
                    </div>
                </div>
                ...
                <div className="w-full px-5 sm:px-10 xl:px-20 py-10 flex flex-wrap gap-3 sm:gap-4 justify-center">
                    {blogCategories.map((category, index) => (
                        <button
                            ...
                            className={`px-5 py-2 rounded-full font-semibold transition-all duration-300 ${activeCategory === category
                    ...
                    <div className="w-full xl:w-7/9">
                        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-8">
                            {filteredBlogs.map((blog) => (
                                <div
                                    key={blog.id}
                                    className="border border-gray-300 rounded-2xl overflow-hidden transition-all duration-300 hover:shadow-xl hover:-translate-y-2 bg-white flex flex-col h-full"
                                >
                                    <img
                                        src={blog.image}
                                        alt={blog.title}
    ...
    <h3 className="font-bold text-xl leading-8 mb-3">
        {blog.title}
    </h3>
...
<div className="flex justify-between items-center pt-4 border-t border-gray-200 mt-auto">
                                            ...
                                            <button className="flex gap-2 items-center text-[#6044da] font-semibold">
                                                Read
                                                <ArrowRight size={16} />
                                            </button>
                                        </div>
                    ...
                    <div className="w-full xl:w-2/9 flex flex-col gap-8">
                                ...
                                {popularPosts.map((post, index) => (
                                    ...
                                    >
                                        <img
                                            src={post.image}
                                            alt={post.title}
                                            className="h-16 w-16 sm:h-18 sm:w-18 rounded-xl object-cover shrink-0"
                                        />
                        ...
                        <div className="bg-[#6044da] rounded-2xl p-6 text-white flex flex-col gap-5">
                            ...
                            <p className="text-purple-100">
                                Share your insights and experiences with
                                learners worldwide.
                            </p>
                ...
                <div className="w-full px-5 sm:px-10 xl:px-20 pb-15">
                    <div className="bg-purple-100 rounded-3xl px-5 sm:px-10 xl:px-15 py-12 flex flex-col items-center gap-6">
                        ...
                        <p className="text-gray-600 text-center max-w-2xl">
                            ...
                            blogs, AI insights, and learning tips delivered to
                            your inbox.
                        </p>
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 w-full max-w-2xl">
                            <input
                                ...
                                className="flex-1 px-5 py-4 rounded-xl border border-gray-300 outline-none bg-white"
                            />

                            <button className="w-full sm:w-auto px-8 py-4 rounded-xl bg-[#6044da] text-white font-semibold">
                                Subscribe
                            </button>
                        </div>
                    </div>
