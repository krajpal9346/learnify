...
import { helpCategoriesData } from "../data/helpCategoriesData";
import { popularArticlesData } from "../data/popularArticlesData";
        ...
        <>
            ...
            <main>
                ...
                <div className="flex flex-col items-center gap-5 px-5 sm:px-10 xl:px-20 pt-28 xl:pt-30 pb-10 bg-purple-100">
                    ...
                    <img
                        className="h-28 sm:h-36 xl:h-40 object-contain"
                        src={headphones}
                        alt="Help center support illustration"
                    />
                    ...
                    <p className="text-gray-600 text-center text-sm sm:text-base px-4">
                        Find answers, solve issues, and make the most of Learnify AI.
                    </p>
                ...
                <div className="flex flex-col gap-5 px-5 sm:px-10 xl:px-20 py-10">
                    ...
                    <div className="w-full grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-6 gap-5">
                        ...
                        {helpCategoriesData.map((category, index) => {
                            const Icon = category.icon;

                            return (
                                <div
                                    key={index}
                                    className="w-full flex flex-col gap-3 px-6 sm:px-8 py-5 rounded-xl items-center border border-gray-300 hover:shadow-lg hover:-translate-y-1 transition-all duration-300 cursor-pointer"
                                >
                                    <div
                                        className={`h-20 w-20 rounded-full ${category.iconBg} flex items-center justify-center`}
                                    >
                                        <Icon
                                    ...
                                    <div className="flex gap-2 items-center">
                                        <p className="text-[#6044da] font-bold">
                                            View articles
                                        </p>
                ...
                <div className="px-5 sm:px-10 xl:px-20 pb-10 flex flex-col xl:flex-row gap-10">
                    ...
                    <div className="w-full xl:w-3/4 border border-gray-300 rounded-xl flex flex-col gap-5 px-5 sm:px-8 py-5">
                        ...
                        {popularArticlesData.map((article, index) => {
                            ...
                            return (
                                <div
                                    key={index}
                                    className={`flex flex-col sm:flex-row sm:justify-between gap-5 ${index !== 0
                                ...
                                >
                                    <div className="flex gap-5 sm:gap-10">
                                        ...
                                        <div
                                            className={`h-14 w-14 sm:h-15 sm:w-18 shrink-0 ${article.iconBg} rounded-xl flex items-center justify-center`}
                                        >
                                            <Icon
                    ...
                    <div className="w-full xl:w-1/3 flex flex-col gap-5">
                        ...
                        <div className="bg-purple-100 w-full rounded-xl flex flex-col gap-3 px-6 sm:px-10 py-5 border border-gray-200">
                            ...
                            <button className="w-full flex gap-3 px-5 py-3 rounded-xl justify-center bg-[#6044da] text-white font-semibold">
                                Contact Support
                        ...
                        <div className="bg-purple-100 w-full rounded-xl flex flex-col sm:flex-row items-center gap-5 px-6 sm:px-10 py-5 border border-gray-200">
                            ...
                            <button className="w-full sm:w-1/2 h-fit flex gap-2 items-center px-4 py-3 rounded-xl justify-center bg-white text-[#6044da] border border-[#6044da] font-semibold">
                                Start Live Chat
                        ...
                        <div className="w-full rounded-xl flex flex-col gap-2 px-6 sm:px-10 py-5 border border-gray-200">
                            ...
                            {miniFaqData.map((faq, index) => (
                                <div
                                    key={index}
                                    className="pb-2 flex justify-between items-center border-b border-gray-200 gap-3"
                                >
                                    <p className="text-gray-700 text-sm sm:text-base">
                                        {faq}
                                    </p>
                    ...
                    <div className="bg-purple-100 w-full items-center border border-gray-100 rounded-xl px-6 sm:px-10 xl:px-20 py-6 flex flex-col xl:flex-row gap-6 xl:gap-0 justify-between">
                        ...
                        <div className="flex flex-col sm:flex-row gap-6 sm:gap-10 items-center text-center sm:text-left">
                            ...
                            <div className="flex flex-col gap-1 justify-center">
                                ...
                                <p className="text-gray-700">
                                    Search our help center or reach out to our support team.
                                </p>
                            </div>
                        </div>

                        <button className="w-full sm:w-auto flex gap-2 bg-[#6044da] text-white px-5 py-3 items-center justify-center font-semibold rounded-xl">
                            Contact Support
